...
fn compile_exclude_newer() -> Result<()> {
    ...
    ----- stderr -----
    error: invalid value '2022-04-04+02:00' for '--exclude-newer <EXCLUDE_NEWER>': `2022-04-04+02:00` could not be parsed as a timestamp, date, or relative duration: failed to parse "2022-04-04+02:00" in the "friendly" format: expected to find unit designator suffix (e.g., 'years' or 'secs'), but found input beginning with "-04-04+02:00" instead
    ...
    ----- stderr -----
    error: invalid value '2022-04-04T26:00:00+00' for '--exclude-newer <EXCLUDE_NEWER>': `2022-04-04T26:00:00+00` could not be parsed as a timestamp, date, or relative duration: failed to parse "2022-04-04T26:00:00+00" in the "friendly" format: expected to find unit designator suffix (e.g., 'years' or 'secs'), but found input beginning with "-04-04T26:00:00+00" instead
...
fn compile_exclude_newer_package_errors() -> Result<()> {
    ...
    ----- stderr -----
    error: invalid value 'tqdm=invalid-date' for '--exclude-newer-package <EXCLUDE_NEWER_PACKAGE>': Invalid `exclude-newer-package` timestamp `invalid-date`: `invalid-date` could not be parsed as a timestamp, date, or relative duration: failed to parse "invalid-date" in the "friendly" format: parsing a friendly duration requires it to start with a unit value (a decimal integer) after an optional sign, but no integer was found
